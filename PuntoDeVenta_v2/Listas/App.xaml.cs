...
namespace Listas
{
    ...
    {
        public static string DB_PATH = Path.Combine(Path.Combine(ApplicationData.Current.LocalFolder.Path, "PuntoDeVenta.sqlite"));
        ...
        public App()
        {
            ...
            if (!CheckFileExists("PuntoDeVenta.sqlite").Result)
            {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame.Content == null)
            {
                ...
                // de navegación
                if (!rootFrame.Navigate(typeof(PuntoDeVenta.ListaVentas), e.Arguments))
                {
